...
global function OnDeployableCloakfieldPlanted
...
const DEPLOYABLE_CLOAKFIELD_RADIUS = 400
...
void function CreateCloakBeacon( entity owner, vector origin, vector angles )
{
	...
	//entity tower = PlantStickyGrenade( DEPLOYABLE_CLOAKFIELD_MODEL, origin, angles, hitEnt, hitbox, 4.0, false )
